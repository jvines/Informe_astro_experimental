...
\begin{itemize}
	...
	\item La funci\'on \textit{ap\_photometry} devuelve el valor del flujo de la estrella.
\end{itemize}

La funci\'on \textit{ap\_photometry} se aplica sobre todos los datos experimentales de la medici\'on wasp5, obteniendo el siguiente gr\'afico:
