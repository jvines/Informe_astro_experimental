...
\begin{itemize}
	...
	\item La funci\'on \textit{ap\_photometry} devuelve el valor del flujo de la estrella con su error asociado.
\end{itemize}
...
\fig{flujo.pdf}{0.9\textwidth}{12cm}{Gr\'afico del flujo de Wasp5 por segundo.}{star}
