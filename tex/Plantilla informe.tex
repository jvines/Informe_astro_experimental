...
\begin{itemize}
	...
	\item Creaci\'on de la funci\'on de fotometr\'ia de apertura: teniendo lo anterior, se puede integrar para obtener el flujo de la estrella. Se suman todos los valores dentro del radio de la estrella y se le resta a este resultado el valor de la mediana del cielo (para que no quede sobreestimado).
\end{itemize}
